...
include("db_connection.php");
      ...
      $result = mysqli_query($conn,"select * from result where subject = '$subjectname' and year = '$year' order by score desc ");   
        if($result -> num_rows >0)
        { 
          echo "<table class='table table-hover text-center'><thead><tr><th style='color:red;'>Roll Number</th><th style='color:green;'>Name</th><th style='color:blue;'>Score</th></tr></thead>";
        while($data = mysqli_fetch_array($result))
        {
          ...
          echo "<tbody><tr><td>".$rollnum."</td><td>".$name."</td><td>".$score." / ".$ttl."</td></tr></tbody>";
        } 
      echo "</table>";
  }
  else{
...
<div align="center">
  <a href="export.php?export=true" class="btn ">Download</a>
</div>
